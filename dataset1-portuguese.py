...
#    Here I am running results of G1->G3, G2->G3, and failures->G3 prediction
...
#    Time to try a different tactic. I am going to run a decision tree model 
#    by predicting pass/fails. This is a binary classification problem. To my 
#    knowledge, a failing grade is 11 or lower in Portugal. 
#    DecisionTreeClassifier, KNeighborsClassifier, and SVC will be used). 
    
#    This first model predicts G3. The training set is all the data minus G3
